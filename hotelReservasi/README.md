...
Aplikasi web Sistem Pendukung Keputusan & Pendaftaran Reservasi Hotel yang dibangun dengan menggunakan bahasa Java, framework Spring Boot, template engine Thymeleaf, dan database MySQL melalui JPA/JDBC.
